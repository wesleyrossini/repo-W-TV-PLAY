...
addon = xbmcaddon.Addon(id='plugin.video.W-TV PLAY')
...
lista = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.W-TV PLAY/lista.xml").decode("utf-8"))
tube  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.W-TV PLAY/tube.xml").decode("utf-8"))
...
def controle_lista():
	    addDir('[COLOR white][B]ADICIONAR LISTA M3U e XML [/COLOR][/B][COLOR blue][B]W-TV[/COLOR] [COLOR red]PLAY[/B][/COLOR]','102',102,icon,FANART,'','','','')
	    addDir('[COLOR white][B]VISUALIZAR LISTA M3U e XML [/COLOR][/B][COLOR blue][B]W-TV[/COLOR] [COLOR red]PLAY[/B][/COLOR]','103',103,icon,FANART,'','','','')
	    addDir('[COLOR white][B]APAGAR A LISTA [/COLOR][/B][COLOR blue][B]W-TV[/COLOR] [COLOR red]PLAY[/B][/COLOR]','105',105,icon,FANART,'','','','')
	    addDir('*******','104',104,icon,FANART,'','','','')
	    
	    addDir('[COLOR white][B]ADICIONAR CONTEUDO YOUTUBE  [/COLOR][/B][COLOR blue][B]W-TV[/COLOR] [COLOR red]PLAY[/B][/COLOR]','111',111,icon,FANART,'','','','')
	    addDir('[COLOR white][B]VISUALIZAR CONTEUDO DO YOUTUBE  [/COLOR][/B][COLOR blue][B]W-TV[/COLOR] [COLOR red]PLAY[/B][/COLOR]','112',112,icon,FANART,'','','','')
	    addDir('[COLOR white][B]APAGAR CONTUDO DO YOUTUBE  [/COLOR][/B][COLOR blue][B]W-TV[/COLOR] [COLOR red]PLAY[/B][/COLOR]','113',113,icon,FANART,'','','','')
...
base = "1RlVHZnejF2L3Fmcv02bj5ibpJWZ0NXYw9yL6MHc0RHa"
tam = len(base)
basedem = base[::-1]
...
def SKindex():
    addon_log("SKindex")
    addDir('[COLOR white][B]O MELHOR DO ENTRETENIMENTO[/COLOR][/B][COLOR blue][B] [/COLOR][COLOR red][/B][/COLOR]','100',100,icon,FANART,'','','','')
    addDir('[COLOR green][B]CLICK AQUI PARA VER OS FILMES EM CARTAZ [COLOR red][B]W-TV [/B][/COLOR][COLOR blue][B]PLAY[/B][/COLOR]','101',101,icon,FANART,'','','','')
   

    addDir('[COLOR white][B]PAREAMENTO CLICK AQUI [/COLOR][/B][COLOR blue][B]W-TV[/COLOR] [COLOR red]PLAY[/B][/COLOR]','104',104,icon,FANART,'','','','')
    getData(off,'')
    #addDir('[COLOR white][B]DESENHOS 24 HORAS [/COLOR][/B][COLOR blue][B]W-TV  [/COLOR][COLOR red]PLAY[/B][/COLOR]','241',241,icon,FANART,'','','','')
    
    msg2 = "https://raw.githubusercontent.com/wesleyrossini/aviso-w-tv-play/master/README.md"				
    msg = msg2 
    line1 = urllib2.urlopen(msg).read()
    time = 00001	 #in miliseconds
...
#                    print 'item link', item('link')
                    ...
                    for i in item('server02'):
                        if not i.string == None:
                            server02 = 'http://cdnv13.ec.cx/RedeCanais/RedeCanais/RCFServer2/ondemand/'+i.string+'.mp4'
                            url.append(server02)
                            
                elif len(item('server04')) >0:
                    for i in item('server04'):
                        if not i.string == None:
                            server04 = 'http://cdnv7.ec.cx/RedeCanais/RedeCanais/RCFServer4/ondemand/'+i.string+'.mp4'
                            url.append(server04)
                    ...
                    for i in item('m3u'):
                        if not i.string == None:
                            m3u = 'plugin://plugin.video.playthis/?mode=play&player=false&path=http://www.dailymotion.com/video/'+i.string+''
                            url.append(m3u)
